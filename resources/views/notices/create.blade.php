...
@section('content')
    ...
    {!! Form::open() !!}
        ...
        <div class="form-group">
            ...
            {!! Form::select('provider_id', [], null, ['class'=> 'form-group']) !!}
        </div>
